...
def generate(cantTiendas):
    ...
    randomNumberGeneration = str(cantTiendas)+" "+str(contLimit) +" "+ str(maxOut + random.randint(0,5)) +" "+ str(random.randint(1, contLimit))+ randomNumberGeneration + " "
    directory = "testInstancesBiggerFirst"
